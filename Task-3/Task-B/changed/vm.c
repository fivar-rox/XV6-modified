...
struct spinlock swapsleeplock;
int swapsleepcount=0;
char *swapsleep; // channel where proceess go to sleep after requesting for a swap.
...
// be page-aligned.
int // removed static so that trap.c could access this function.
